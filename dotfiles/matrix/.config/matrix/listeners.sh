...
declare -A LISTENERS
LISTENERS["low-bat-notification"]="$HOME/.config/matrix/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/matrix/listeners/another-listener.sh"
