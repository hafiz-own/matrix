...
# DESC: Applies GTK themes and settings to the current session.
...
Applies GTK themes and settings to the current session.
...
terminal=$(cat $HOME/.config/matrix/settings/terminal.sh)
