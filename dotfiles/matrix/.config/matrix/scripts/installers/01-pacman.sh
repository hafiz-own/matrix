...
# DESC: Optimizes pacman and makepkg configurations for faster package installation.
...
Optimizes pacman and makepkg configurations for faster package installation.
