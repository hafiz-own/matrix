...
-- Applications
hl.bind(mainMod .. " + RETURN", hl.dsp.exec_cmd("~/.config/matrix/settings/terminal.sh"), { description = "Open the terminal" })
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("~/.config/matrix/settings/browser.sh"), { description = "Open the browser" })
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("~/.config/matrix/settings/filemanager"), { description = "Open the filemanager" })
hl.bind(mainMod .. " + CTRL + C", hl.dsp.exec_cmd("~/.config/matrix/settings/calculator.sh"), { description = "Open the calculator" })
...
-- Windows
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd("~/.config/matrix/scripts/killactive.sh"), { description = "Kill active window" })
...
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("~/.config/matrix/scripts/matrix-toggle-allfloat"), { description = "Toggle floating for all windows of workspace" })
...
hl.bind("PRINT", hl.dsp.exec_cmd("~/.config/matrix/scripts/matrix-capture-ui.sh"), { description = "Matrix Capture (Screenshot/OCR/Record)" })
hl.bind(mainMod .. " + CTRL + RETURN", hl.dsp.exec_cmd("~/.config/walker/launch.sh"), { description = "Open application launcher" })
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("~/.config/walker/scripts/dictionary.sh"), { description = "Open Dictionary Search`" })
hl.bind(mainMod .. " + SHIFT + B", hl.dsp.exec_cmd("~/.config/matrix/scripts/matrix-reload-statusbar"), { description = "Reload Status Bar" })
hl.bind(mainMod .. " + CTRL + B", hl.dsp.exec_cmd("~/.config/matrix/scripts/matrix-toggle-statusbar"), { description = "Toggle Status Bar" })
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("~/.config/matrix/scripts/matrix-cliphist"), { description = "Open clipboard manager" })
hl.bind(mainMod .. " + ALT + G", hl.dsp.exec_cmd("~/.config/hypr/scripts/gamemode.sh"), { description = "Toggle game mode" })
hl.bind(mainMod .. " + CTRL + L", hl.dsp.exec_cmd("~/.config/matrix/scripts/matrix-power -l"), { description = "Lock Screen" })
hl.bind("CTRL + ALT + T", hl.dsp.exec_cmd("~/.config/matrix/themes/themes.sh"), { description = "Open Select Window Menu" })

-- Example special workspace (scratchpad)
hl.bind(mainMod .. " + S",         hl.dsp.workspace.toggle_special("magic"), { description = "Toggle special workspace magic" })
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("~/.config/matrix/scripts/matrix-toggle-scratchpad-window"), { description = "Toggle window in/out of special workspace magic" })
...
hl.bind("XF86AudioPause", hl.dsp.exec_cmd("mpc toggle"), { locked = true, description = "Pause audio" })
hl.bind("XF86AudioPlay",  hl.dsp.exec_cmd("mpc toggle"), { locked = true, description = "Play audio" })
hl.bind("XF86AudioPrev",  hl.dsp.exec_cmd("mpc previous"),   { locked = true, description = "Previous track" })

-- Playback controls — locked = true enables lockscreen control
hl.bind("SUPER + F9",  hl.dsp.exec_cmd("~/.config/hypr/scripts/mpd_safe.sh toggle"), { locked = true })
hl.bind("SUPER + F10", hl.dsp.exec_cmd("~/.config/hypr/scripts/mpd_safe.sh prev"),   { locked = true })
hl.bind("SUPER + F11", hl.dsp.exec_cmd("~/.config/hypr/scripts/mpd_safe.sh next"),   { locked = true })
hl.bind("SUPER + F12", hl.dsp.exec_cmd("~/.config/hypr/scripts/mpd_safe.sh stop"),   { locked = true })

-- MPD volume
hl.bind("SUPER + F7", hl.dsp.exec_cmd("mpc volume +5"), { locked = true })
hl.bind("SUPER + F6", hl.dsp.exec_cmd("mpc volume -5"), { locked = true })

-- Lyrics toggle
hl.bind("SUPER + F8", hl.dsp.exec_cmd("~/.config/hypr/scripts/lyrics_toggle.sh"), { locked = true })

-- Persist lyrics state on startup
--hl.on("hyprland.start", function()
--    hl.exec_cmd("touch /tmp/lyrics_enabled")
--+end)

-- Voxtype Dictation
hl.bind("SUPER + CTRL + X", hl.dsp.exec_cmd("voxtype record toggle"), { description = "Toggle AI Dictation" })
hl.bind("F9", hl.dsp.exec_cmd("voxtype record start"), { description = "Start AI Dictation" })
hl.bind("F9", hl.dsp.exec_cmd("voxtype record stop"), { description = "Stop AI Dictation", release = true })
